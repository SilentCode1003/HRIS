...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.sequelize.query(`
      CREATE PROCEDURE RequestRestDayOt(
          IN clockIn DATETIME,
          ...
          INSERT INTO restday_ot_approval (
            roa_employeeid,
            roa_fullname,
            roa_timein,
            roa_timeout,
            ...
            roa_normal_ot_hour,
            roa_early_ot_hour,
            roa_nightdiff_minutes,
            roa_normal_ot_minutes,
            roa_early_ot_minutes,
            roa_nightdiff_pay_hour,
            roa_normal_ot_pay_hour,
            roa_early_ot_pay_hour,
            roa_nightdiff_pay_minutes,
            roa_normal_ot_pay_minutes,
            roa_early_ot_pay_minutes,
            roa_total_nightdiff,
            roa_total_normal,
            roa_total_early,
            roa_ot_total,
          ...
          SELECT 
            ...
            END, 0) AS nightDifferentialCalculation,
            COALESCE(CASE 
            ...
            END, 0) AS normalOvertimeCalculation,
            COALESCE(CASE 
            ...
            END, 0) AS earlyOvertimeCalculation,
            COALESCE(CASE 
            ...
            END, 0) AS nightDifferentialMinutesCalculation,
            COALESCE(CASE 
            ...
            END, 0) AS normalOvertimeMinutesCalculation,
            COALESCE(CASE 
            ...
            END, 0) AS earlyOvertimeMinutesCalculation,
            COALESCE((CASE 
              WHEN rdotType = 'RDOT W/ Regular Holiday' THEN (nightDifferentialHours * ndot_hour) * 2
              WHEN rdotType = 'RDOT W/ Special Holiday' THEN (nightDifferentialHours * ndot_hour) * 1.3
              ELSE nightDifferentialHours * ndot_hour
            END + CASE 
              ...
              WHEN rdotType = 'RDOT W/ Special Holiday' THEN (nightDifferentialMinutes * ndot_min) * 1.3
              ELSE nightDifferentialMinutes * ndot_min
            END), 0) AS totalNightDifferential,
            COALESCE((CASE 
              WHEN rdotType = 'RDOT W/ Regular Holiday' THEN (normalOverTimeHours * not_hour) * 2
              WHEN rdotType = 'RDOT W/ Special Holiday' THEN (normalOverTimeHours * not_hour) * 1.3
              ELSE normalOverTimeHours * not_hour
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.sequelize.query(`
      DROP PROCEDURE IF EXISTS RequestRestDayOt;
    `);
  }
};
