...
router.post("/save", (req, res) => {
    try {
      ...
      const { deduction_name, payroll_date, amount,
        file, description,
       } = req.body;
      ...
      let data = [[deduction_name, payroll_date, amount, description, file, createdby, createddate]];
...
router.put("/edit", (req, res) => {
    try {
      ...
      const { deduction_name, payroll_date, amount, description,
        file , deductionsid
       } = req.body;
