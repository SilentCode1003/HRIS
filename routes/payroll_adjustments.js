...
router.get("/load", (req, res) => {
  ...
  router.post("/save", (req, res) => {
    try {
      ...
      const { employeeid, adjustmenttype, adjustmentamount,
        adjustmentreason, origindate, payrolldate,
       } = req.body;
  ...
  router.put("/edit", (req, res) => {
    try {
      const { adjustmentid, employeeid, 
        origindate, adjustmenttype, adjust_amount, payrolldate,
        adjustmentstatus, reason} = req.body;
      let createby = req.session.fullname;
      let createdate = currentDate.format("YYYY-MM-DD HH:mm:ss");
